...
| `qualys-ci-lookup-rules` | SNOWUSEMTP-895 Qualys CI lookup rules (readable rewrite, no setLimit) | 16 rewritten rule scripts, plus 3 rules and 6 properties for the unmatched population; sets V2.0 to V2.2, V3.0 |
