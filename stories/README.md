...
| `qualys-ci-lookup-rules` | SNOWUSEMTP-895 Qualys CI lookup rules (readable rewrite, no setLimit) | 16 rule scripts on `sn_sec_cmn_ci_lookup_rule`; sets V2.0 to V2.2 |
