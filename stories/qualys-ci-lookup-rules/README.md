...
Update set `SNOWUSEMTP-895_MS_Qualys CI Lookup Rules_V3.1` (Global, 9 updates: 3 rules + 6 properties; V3.0
was the first cut, V3.1 carries the rewritten comments) applies on top of V2.3. `build_rules_v3.py` deploys, `test_v3.py` creates the fixtures and runs 18
