/* USEM IP Class Match
   ...
   Input  : sourceValue is the IP field, "30.162.178.21"; the rule also reads the OS from
            sourcePayload.
   Returns: the sys_id of the one CI of that class whose ip_address equals the scanned address, when
            its name agrees with the scanned host name; null when none or two carry it or the name
            differs.
