...
d = ui.js('''
var o = {};
var us = new GlideRecord('sys_update_set'); us.get(%s); us.setValue('name', 'SNOWUSEMTP-1625_MS_Remediation Task CDP Payload_V2.3'); us.setValue('state', 'complete'); us.update();
