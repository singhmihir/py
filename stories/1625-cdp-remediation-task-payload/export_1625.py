...
NAME = 'SNOWUSEMTP-1625_MS_Remediation Task CDP Payload_V2.1'
OUT = BASE + '/stories/1625-cdp-remediation-task-payload/Remediation Task CDP Payload - Update Set.xml'
d = ui.js('''
var o = {};
var us = new GlideRecord('sys_update_set'); us.get(%s); us.setValue('name', 'SNOWUSEMTP-1625_MS_Remediation Task CDP Payload_V2.1'); us.setValue('state', 'complete'); us.update();
